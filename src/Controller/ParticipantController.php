...
class ParticipantController extends AbstractController
{
    ...
    public function new(Request $request, ParticipantRepository $participantRepository, UserPasswordHasherInterface $passwordHasher): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Vous avez rajouté un participant !');
    ...
    public function delete(Request $request, Participant $participant, ParticipantRepository $participantRepository): Response
    {
        if ($this->isCsrfTokenValid('delete' . $participant->getId(), $request->request->get('_token'))) {
            ...
            $this->addFlash('success', 'Vous venez de vous débarasser de quelqu\'un. Veillez à bien effacer toutes les preuves, et vérifiez qu\il n\'y ait pas de témoin gênant...!');
        }
